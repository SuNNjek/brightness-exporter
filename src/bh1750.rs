...
//!
//! This driver was built using [`embedded-hal`] traits and stolen from [`GitHub`] :P.
//!
//! [`embedded-hal`]: https://docs.rs/embedded-hal/~0.1
//! [`GitHub`]: https://github.com/wose/bh1750/blob/master/src/lib.rs
